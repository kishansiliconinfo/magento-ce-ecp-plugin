...
class EComProcessing_Genesis_Block_Redirect_Standard extends Mage_Core_Block_Abstract
{
	public function _toHtml()
	{
		$target = Mage::getSingleton('core/session')->getEComProcessingStandardRedirectUrl();
