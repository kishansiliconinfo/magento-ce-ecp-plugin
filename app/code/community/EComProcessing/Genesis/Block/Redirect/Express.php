...
class EComProcessing_Genesis_Block_Redirect_Express extends Mage_Core_Block_Abstract
{
	public function _toHtml()
	{
		$target = Mage::getSingleton('core/session')->getEComProcessingExpressRedirectUrl();
