...
class EComProcessing_Genesis_Model_Express extends Mage_Payment_Model_Method_Abstract
{
	/**
	 ...
	 * @var string [a-z0-9_]
	 */
	protected $_code = 'ecomprocessing_express';

	protected $_formBlockType = 'ecomprocessing/form_express';
	protected $_infoBlockType = 'ecomprocessing/info_express';
	 ...
	 *
	 * @see EComProcessing_Genesis_ExpressController
	 *
	 * @note In order for redirect to work, you must
	 * set the session variable "EComProcessingGenesisExpressRedirectUrl"
	 *
	 * @return mixed
	 */
