...
{
	// Variables
    protected $_code = 'ecomprocessing_standard';

	//protected $_formBlockType = 'ecomprocessing/form_standard';
	protected $_formBlockType = 'payment/form_ccsave';
	protected $_infoBlockType = 'ecomprocessing/info_standard';
	...
	private function _authorize3d($payment, $amount)
	{
		...
		try {
			...
			Mage::getSingleton('core/session')->setEComProcessingStandardRedirectUrl(
	 ...
	 *
	 * @see EComProcessing_Genesis_StandardController::notifyAction
	 *
	 * @param $unique_id
	 * @return mixed
	 */
	 ...
	 *
	 * @see EComProcessing_Genesis_StandardController
	 *
	 * @note In order for redirect to work, you must
	 * set the session variable "EComProcessingStandardRedirectUrl"
	 *
	 * @return mixed
	 */
