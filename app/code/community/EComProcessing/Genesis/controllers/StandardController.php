...
class EComProcessing_Genesis_StandardController extends Mage_Core_Controller_Front_Action
{
	/**
	...
	public function redirectAction()
	{
		...
		$session->setEComProcessingStandardQuoteId($session->getQuoteId());
		$this->getResponse()->setBody(
			$this->getLayout()->createBlock('ecomprocessing/redirect_standard')->toHtml()
		);
		$session->unsQuoteId();
		$session->unsEComProcessingStandardRedirectUrl();
	}
	...
	{
		$session = Mage::getSingleton('checkout/session');
		$session->setQuoteId($session->getEComProcessingStandardQuoteId(true));
	...
	public function notifyAction()
	{
		...
		$standard   = Mage::getModel('ecomprocessing/standard');
